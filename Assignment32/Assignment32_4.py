...
Log.txt. Log.txt file should be created into current directory. Display execution time 
...
def DirectoryTravesal(DirectoryName):
    ...
    if os.path.exists(DirectoryName):
        ...
        fobj.write(f"Time take by application is : {end_time - start_time} Second \n" )
        fobj.write(Border + "\n")
        fobj.close()
