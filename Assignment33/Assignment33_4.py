...
def main():
    ...
    if len(sys.argv) == 2:
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("4: store iinformation about processess")
            print("5: store iinformation about CPU")
            print("6: store iinformation about RAM Usage")
            print("7: store iinformation about secondary storage")
